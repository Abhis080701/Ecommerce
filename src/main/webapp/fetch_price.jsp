...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
                               ...
                               <%
                               int min = Integer.parseInt(request.getParameter("Min_price"));
                               int max = Integer.parseInt(request.getParameter("Max_price"));
                              ...
                              rs.next();
                            	   if(rs.getInt(1)==0){
                            		   out.print("<div class='col-md-3'><span style='color:red;'>No Such Category Product is Found </span></div>");
                            			   ...
                            			   {
                            				   if(rs3.getInt("psellprice")>=min && rs3.getInt("psellprice")<=max)
                            				   {
                            			   %>
