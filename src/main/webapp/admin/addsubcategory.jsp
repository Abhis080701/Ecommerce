        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> <a href="Subcategory.jsp" class="btn  btn-success" >ViewSubCategory</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form  action="addsubcategory"  method="POST" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="sname"  placeholder="Enter Name" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input"  name="simage" required>
