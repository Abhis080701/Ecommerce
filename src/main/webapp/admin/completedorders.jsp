        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Cart Order's</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  try
                  {
                   ...
                   rs = st.executeQuery("SELECT * FROM user_cart_order WHERE status='"+status+"'  ORDER BY orderid  LIMIT  " + start_form + "," + limit + " ");
                   while(rs.next())
                   {
              ...
              <div class="card-footer text-center">
                ...
                try
                {
                	...
                	rs1  = st1.executeQuery("SELECT COUNT(orderid) FROM user_cart_order WHERE status='"+status+"'");
                	rs1.next();
                	Total_Records = rs1.getInt(1);
                
                	Total_Pages = (int) Math.floor(Total_Records / limit);
                 out.print("<a href='completedorders.jsp?page2="+ (page2 - 1 == 0 ? page2 = 1 : (page2 - 1)) + "' class='btn btn-sm btn-secondary '>Prev</a>");
             	for (int i = 1; i <= Total_Pages; i++) {
                out.print("<a href='completedorders.jsp?page2="+i+"' class='btn btn-sm btn-info '>"+i+"</a>"); 
             	}
               out.print("<a href='completedorders.jsp?page2="+ ((page2 + 1) > Total_Pages ? (page2 = Total_Pages + 1) : page2 + 1) + "' class='btn btn-sm btn-secondary'>Next</a>");
                }catch(Exception ex)
                {
                	out.print(ex);
                }
