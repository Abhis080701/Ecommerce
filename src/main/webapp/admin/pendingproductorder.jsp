            ...
            <div class="card">
              ...
              <div class="card-footer text-center">
                ...
                try
                {
                 ...
                 out.print("<a href='pendingproductorder.jsp?page2="+ (page2 - 1 == 0 ? page2 = 1 : (page2 - 1)) + "' class='btn btn-sm btn-secondary '>Prev</a>");
             	for (int i = 1; i <= Total_Pages; i++) {
                out.print("<a href='pendingproductorder.jsp?page2="+i+"' class='btn btn-sm btn-info '>"+i+"</a>"); 
             	}
               out.print("<a href='pendingproductorder.jsp?page2="+ ((page2 + 1) > Total_Pages ? (page2 = Total_Pages + 1) : page2 + 1) + "' class='btn btn-sm btn-secondary'>Next</a>");
                }catch(Exception ex)
                {
                	out.print(ex);
                }
