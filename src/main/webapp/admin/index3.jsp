            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  try
                  {
                   ...
                   rs = st.executeQuery("SELECT * FROM user_order ORDER BY orderid DESC LIMIT " + start_form + "," + limit + "");
                   while(rs.next())
                   {
                  %>
                    <tr>
              ...
              <div class="card-footer text-center">
                ...
                try
                {
                	...
                	rs1  = st1.executeQuery("SELECT COUNT(orderid) FROM user_order");
                	rs1.next();
                	Total_Records = rs1.getInt(1);
                	Total_Pages = (int) Math.floor(Total_Records / limit);
                 out.print("<a href='index3.jsp?page3="+ (page3 - 1 == 0 ? page3 = 1 : (page3 - 1)) + "' class='btn btn-sm btn-secondary '>Prev</a>");
             	for (int i = 1; i <= Total_Pages; i++) {
                out.print("<a href='index3.jsp?page3="+i+"' class='btn btn-sm btn-info '>"+i+"</a>"); 
             	}
               out.print("<a href='index3.jsp?page3="+ ((page3 + 1) > Total_Pages ? (page3 = Total_Pages + 1) : page3 + 1) + "' class='btn btn-sm btn-secondary'>Next</a>");
                }catch(Exception ex)
                {
                	out.print(ex);
                }
