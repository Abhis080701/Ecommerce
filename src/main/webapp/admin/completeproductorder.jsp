  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Product Order's</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  try
                  {
                   ...
                   rs = st.executeQuery("SELECT * FROM user_order WHERE status='"+status+"'  ORDER BY orderid  LIMIT  " + start_form + "," + limit + " ");
                  ...
                  %>
                    <tr>
                      ...
                      <td><span class="badge badge-warning"><%= rs.getString("status") %>
              ...
              <div class="card-footer text-center">
                ...
                try
                {
                	...
                	rs1  = st1.executeQuery("SELECT COUNT(orderid) FROM user_order WHERE status='"+status+"'");
                	rs1.next();
                	Total_Records = rs1.getInt(1);
                
                	Total_Pages = (int) Math.floor(Total_Records / limit);
                 out.print("<a href='completeproductorder.jsp?page2="+ (page2 - 1 == 0 ? page2 = 1 : (page2 - 1)) + "' class='btn btn-sm btn-secondary '>Prev</a>");
             	for (int i = 1; i <= Total_Pages; i++) {
                out.print("<a href='completeproductorder.jsp?page2="+i+"' class='btn btn-sm btn-info '>"+i+"</a>"); 
             	}
               out.print("<a href='completeproductorder.jsp?page2="+ ((page2 + 1) > Total_Pages ? (page2 = Total_Pages + 1) : page2 + 1) + "' class='btn btn-sm btn-secondary'>Next</a>");
                }catch(Exception ex)
                {
                	out.print(ex);
                }
