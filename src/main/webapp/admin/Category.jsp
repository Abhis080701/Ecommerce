								...
								<div class="card-body">
									...
									<div class="card-body">
										<div class="table-responsive">
											...
											try {
												...
												ResultSet rs = st.executeQuery("SELECT * FROM category ORDER BY cid DESC LIMIT " + start_form + "," + limit + "");
											%>
											<table class="table m-0">
												...
												<tbody>
													...
													%>
													<tr>
														<td><a href="#"><%=rs.getInt("cid")%></a></td>
														<td><%=rs.getString("cname")%></td>
														<td><img alt="<%=rs.getString("cimage")%>"
															src="categoryimg/<%=rs.getString("cimage")%>" height="90"
															width="78"></td>
														<td><span class="badge badge-success"><%=rs.getString("created_at")%></span></td>
														<td><a
															href="deletecategory.jsp?cid=<%=rs.getInt("cid")%>"><i
																class="fa fa-trash red-color"></i></a> &nbsp; &nbsp; <a
															href="editcategory.jsp?cid=<%=rs.getInt("cid")%>"><i
																class="fa fa-edit red-color"></i></a></td>
													</tr>
													<%
													}
									...
									<div class="card-footer clearfix">
										...
										try {
											...
											ResultSet rs1 = st1.executeQuery("SELECT COUNT(cid) FROM category");
											rs1.next();
											...
											out.print("<li class='page-item'><a class='page-link' href='Category.jsp?page1="
											+ (page1 - 1 == 0 ? page1 = 1 : (page1 - 1)) + "'>&laquo;</a></li>");
											for (int i = 1; i <= Total_Pages; i++) {
												out.print("<li class='page-item'><a class='page-link' href='Category.jsp?page1=" + i + "'>" + i + "</a></li>");
											}
											out.print("<li class='page-item'><a class='page-link' href='Category.jsp?page1="
											+ ((page1 + 1) > Total_Pages ? (page1 = Total_Pages + 1) : page1 + 1) + "'>&raquo;</a></li>");
