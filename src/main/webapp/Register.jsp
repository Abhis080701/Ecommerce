...
if(mesg!=null && mesg.equals("EmailAlE"))
{
%>
<div class="alert">
...
<% }else if(mesg!=null &&  mesg.equals("VerifyE"))
{
%>
<div class="info">
<span class="closebtninfo" onclick="this.parentElement.style.display='none';">&times;</span>
<strong>TO Verify your Account Link is Send  to Email SuccessFully!</strong>
</div>
<%
}
%>
...
<input type="password" placeholder="Enter the PassWord" name="upass" required>
 ...
 <div class="gender-details">
          ...
          <label for="dot-2">
            <span class="gender">If Already Have Account? </span>
