                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="product-view-top">
                                        <div class="row">
                                            <div class="col-md-4">
                                                  <div class="product-search" id="search-bar">
                                                
                                                    <input type="text" placeholder="search....."autocomplete="off" id="search">
                                                              <div style="position: relative; margin-top: -0px; margin-left: 10px;">
				                       <ul id="searchlist">
                                                ...
                                                <div class="product-price-range">
                                                    <div class="dropdown">
                                                        ...
                                                        <a href="product-listByPrice.jsp?price=3000&p2=4000" class="dropdown-item">$3000 to $4000</a>
                                                         <a href="product-listByPrice.jsp?price=5000&p2=10000" class="dropdown-item">$5000 to $10000</a>       
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                              ...
                              ResultSet rs1 = st1.executeQuery("SELECT * FROM category WHERE cname='"+cname+"'");
                              while(rs1.next())
                              {
                              
                            	  Statement st2 = conn.createStatement();
                            	  ResultSet rs2 = st2.executeQuery("SELECT * FROM subcategory WHERE cid='"+rs1.getInt("cid")+"'");
                            	  while(rs2.next())
                            	  {
                               Statement st = conn.createStatement(); 
                               ResultSet rs = st.executeQuery("SELECT * FROM product ORDER BY pid DESC LIMIT " + start_from + "," + limit + " ");
                               while(rs.next())
                               {
                            	   if(rs2.getString("sid").equals(rs.getString("sid")))
                            	   {
                               %>
