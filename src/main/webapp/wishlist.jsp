                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                          ...
                          <a href="wishlist.jsp" class="nav-item nav-link active">WishList</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div style="display:<% if(alert!=null){out.print(alert);}else{out.print("none");} session.removeAttribute("alert");%>" class="alert alert-success alert-dismissable mt-3">
                       ...
                       <tr>
                       <td colspan="7">
                       <h2 class="text-center text-danger m-0"> Products in Your Wishlist!</h2>
                       </td>
                       </tr>
                       <tr>
                       <th>ID</th>
                       ...
                       try
                       {
                    	   ...
                    	   st.executeUpdate("CREATE TABLE	IF NOT EXISTS "+sb2+"(id int NOT NULL AUTO_INCREMENT,pid int(200),user_email varchar(200),product_name varchar(200),product_price varchar(300),product_image varchar(300),product_code varchar(200),created_at timestamp,PRIMARY KEY(id),FOREIGN KEY (pid) REFERENCES product(pid))");
                       ...
                       <td><a href="addtowish.jsp?remove=<%= rs.getInt("id") %>" class="text-danger lead"><i class="fas fa-trash-alt"></i></a></td>
                      <%  grand_total+=rs.getDouble("product_price"); %>
                       </tr>
                      ...
                      <td colspan="4"></td>
                       <td colspan="1">
                         <a href="addtowish.jsp?clear=all" onclick="return confirm('Are you sure to Clear?');" class="btn btn-danger  <%= (grand_total>1.0d)? " ":"disabled" %>"> <i class="fas fa-trash"></i>&nbsp;&nbsp;Clear Cart</a>
                       </td>
                       </tr>
                       </tbody>
