...
//out.print(pid+"  "+pname+"   "+psellprice+"   "+pimage+"  "+pcolor+"  "+productcode);	
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 px-4 pb-4" id="order">
                  ...
                  <div class="jumbotron p-3 mb-2 text-center">
                    <h6 class="label"><b>Product Image: </b><span style="color:red;"> &nbsp;&nbsp;&nbsp; <img src="admin/productimg/product2/<%= pimage %>" width="70" height="80"> </span></h6>
                           <h6 class="label"><b>Products(Quantity):</b><span style="color:green;"><%= pname+"("+quantity+")" %></span></h6>
                           <h6 class="label"><b>Delivery Charges:</b><%= "Free" %></h6>
                           <h6 class="lead"><b>Pay Amount:  <i class="fas fa-rupee-sign"></i><span style="color:red;"><%= psellprice %></span> </b></h6>

                  </div>
                  
                  <form action="" method="POST" id="PlaceBuyNow">
                  <input type="hidden" name="products" value="<%= pname+"("+quantity+")" %>">
                  <input type="hidden" name="grand_total" value="<%= psellprice %> ">
...
// PlaceOrder
$("#PlaceBuyNow").submit(function(e){
e.preventDefault();
$.ajax({
url:'productbuynow.jsp',
method:'post',
data:$('form').serialize()+"&action=BuyNoworder",
